...
import logoqueimada from "../assets/logoqueimada.png"
        ...
        <>
            ...
            <div class="match-info">
                <div class="match">
                    ...
                    <p class="match-p">
                        Itália <img src={italia} alt="Bandeira Itália" class="flag-circle" /> 2 x 0
                ...
                <div class="match">
                    ...
                    <p class="match-p">
                        Brasil <img src={brasil} alt="Bandeira Brasil" class="flag-circle" /> 3 x 2
                ...
                <div class="match">
                    ...
                    <p class="match-p">
                        Alemanha <img src={alemanha} alt="Bandeira Angola" class="flag-circle" /> 1 x 2
                ...
                <div class="match">
                    ...
                    <p class="match-p">
                        Angola <img src={angola} alt="Bandeira Alemanha" class="flag-circle" /> 1 x 0
