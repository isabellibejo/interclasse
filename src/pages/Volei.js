...
import logovolei from "../assets/logovolei.png"
        ...
        <>
            ...
            <div class="match-info">
                <div class="match">
                    ...
                    <p class="match-p">
                        Itália <img src={italia} alt="Bandeira Itália" class="flag-circle" /> 1 x 2
                        <img src={inglaterra} alt="Bandeira Bélgica" class="flag-circle" /> Inglaterra
                    </p>
                </div>
                <div class="match">
                    <strong>22/08 - Quinta - 07:00</strong>
                    <p class="match-p">
                        Brasil <img src={brasil} alt="Bandeira Brasil" class="flag-circle" /> 4 x 0
                        <img src={tcheca} alt="Bandeira theca" class="flag-circle" /> Rep. Tcheca
                    </p>
                </div>
                <div class="match">
                    <strong>27/08 - Terça - 08:30</strong>
                    <p class="match-p">
                        Angola <img src={angola} alt="Bandeira Angola" class="flag-circle" /> 3 x 0
                        <img src={belgica} alt="Bandeira Bélgica" class="flag-circle" /> Bélgica
                    </p>
                </div>
                <div class="match">
                    <strong>30/08 - Sexta - 10:40</strong>
                    <p class="match-p">
                        Alemanha <img src={alemanha} alt="Bandeira Alemanha" class="flag-circle" /> 2 x 2
